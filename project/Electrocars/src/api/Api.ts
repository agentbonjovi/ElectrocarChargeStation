...
export class HttpClient<SecurityDataType = unknown> {
  ...
  constructor({ securityWorker, secure, format, ...axiosConfig }: ApiConfig<SecurityDataType> = {}) {
    this.instance = axios.create({ ...axiosConfig, baseURL: axiosConfig.baseURL || "http://192.168.56.1:8000" ,withCredentials:true});
    this.secure = secure;
    this.format = format;
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  ...
  stationsReports = {
     ...
     * @name StationsReportsPutPowerUpdate
     * @request PUT:/stations-reports/{report_id}/{station_id}/put_power/
     * @secure
     */
    stationsReportsPutPowerUpdate: (reportId: string, stationId: string, data: number, params: RequestParams = {}) =>
      this.request<void, void>({
        path: `/stations-reports/${reportId}/${stationId}/put_power/`,
        method: "PUT",
        body: data,
        secure: true,
        type: ContentType.Json,
